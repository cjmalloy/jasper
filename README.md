...
Dependencies can be specified in `requirements`: use an npm package specification for JavaScript and a pip
requirements string for Python. JavaScript requirements are installed and made available via npx.
