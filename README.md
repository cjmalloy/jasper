...
| `JASPER_MIN_FETCH_ROLE`                             | Minimum role required to fetch external resources.                                                                             | `ROLE_ANONYMOUS`                                                                                                                                                                                              |
| `JASPER_MIN_CONFIG_ROLE`                            | Minimum role required to edit plugins and templates.                                                                           | `ROLE_ANONYMOUS`                                                                                                                                                                                              |
| `JASPER_MIN_READ_BACKUPS_ROLE`                      | Minimum role required to download backups.                                                                                     | `ROLE_ANONYMOUS`                                                                                                                                                                                              |
