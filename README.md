...
[![SwaggerHub](https://img.shields.io/badge/SwaggerHub-1.2.28-brightgreen)](https://app.swaggerhub.com/apis/cjmalloy/Jasper)
...
| `JASPER_OVERRIDE_SERVER_SCRIPT_ORIGINS`        | Override the server origins that can run scripts.                                                                              |                                                                                                                                                                                                               |
| `JASPER_OVERRIDE_SERVER_SCRAPE_HOST_WHITELIST` | Override the server list of whitelisted hosts.                                                                                 |                                                                                                                                                                                                               |
| `JASPER_OVERRIDE_SERVER_SCRAPE_HOST_BLACKLIST` | Override the server list of blacklisted hosts.                                                                                 |                                                                                                                                                                                                               |
