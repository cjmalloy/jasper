...
public interface JasperClient {
	...
	ResponseEntity<InputStreamResource> fetch(URI baseUri, @Param("url") String url, @Param("origin") String origin);
	@RequestLine("GET /pub/api/v1/repl/cache?url={url}&origin={origin}")
	ResponseEntity<InputStreamResource> fetch(URI baseUri, @HeaderMap Map<String, Object> headers, @Param("url") String url, @Param("origin") String origin);
