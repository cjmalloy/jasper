...
public class TemplateSpec {
	 ...
	 */
	public static Specification<Template> applySortingSpec(Specification<Template> spec, Pageable pageable) {
	 ...
	 * Supports config->, defaults->, schema-> fields.
	 * Supports ":num" suffix for numeric sorting and ":len" suffix for array length sorting.
	 * Uses COALESCE to handle nulls (0 for numeric/length, '' for string).
	 */
	private static Expression<?> createJsonbSortExpression(Root<Template> root, CriteriaBuilder cb, String property) {
