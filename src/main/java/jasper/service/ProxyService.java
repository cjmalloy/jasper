...
public class ProxyService {
	...
	public void preFetch(String url) throws URISyntaxException, IOException {
	...
	public void fetchIfExists(String url, OutputStream os) {
		if (fileCache.isEmpty() || !refRepository.existsByUrlAndOrigin(url, auth.getOrigin())) throw new NotFoundException("Cache not found");
