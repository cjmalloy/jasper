...
public class ProfileService {
	...
	public void create(String qualifiedTag, String password, String role) {
		...
		profileManager.createUser(qualifiedTag.substring("user/".length()), password, getRoles(role));
	}
	...
	public void changeRole(String qualifiedTag, String role) {
		validateRole(role);
		profileManager.changeRoles(qualifiedTag.substring("user/".length()), getRoles(role));
	}
